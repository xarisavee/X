		                                		...
		                                		<div class="col-lg-12 col-lg-offset-0 divbreak">   		
													...
													<div class="smalldivbreak">
														<div class="col-lg-12 form-group">							
															...
															<input class="form-control" id="coop_name" name="coop_name" placeholder="Business Name" value="" required="">
														</div>
													</div>
													<div class="smalldivbreak">
														<div class="col-lg-12 form-group">							
													...
													<div class="smalldivbreak">
														<div class="col-lg-12 form-group">							
															...
															<input class="form-control" id="coop_email" name="coop_email" placeholder="User Email Address" value="" required="" >
														</div>
													</div>
													<div class="smalldivbreak">
														<div class="col-lg-12 form-group">							
