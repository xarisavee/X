											...
											<tbody>
													<tr>
														...
														<td> 
															...
															<button type="button" class="btn btn-success" onclick="view();" title="View Profile"><i class="fa fa-user"></i></button>&nbsp;
															@if($checkLoans!=0)
	...
	function viewLoanBook() {
		...
		for (var i=0; i<rows.length; i++) {
			rows[i].onclick = function () {
				...
				var cells = this.cells; //cells collection
				var member_id = cells[0].innerHTML;
				location.href = "../loanbook/"+member_id;
