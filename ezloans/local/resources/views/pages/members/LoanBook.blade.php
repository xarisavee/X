								...
								<div class="row">
									<div class="col-sm-4 col-lg-4">
										<div class="form-group text-center">
											...
											<button id="startnew" class="btn btn-danger" onclick="applyLoan()"><i class="fa fa-fa-plus"></i>&nbsp;New Loan Application</button>
										</div>
									</div>
							...
							<div class="row">
								<div id="LoanBook">
									<ul class="nav nav-tabs">
										...
										<li><a data-toggle="tab" id="sharecapitalTab" href="#AllLoans">All Loans</a></li>
									</ul>
												...
												<div class="row">
													<div class="resultarea">
														<table id="activeloanstable" class="table table-responsive table-bordered table-hover text-center table-condensed">
															...
															@foreach($activeloans as $loans => $data)
															<tbody>
																<tr>
												...
												<div class="row">
													<div class="resultarea">
														<table id="allloanstable" class="table table-responsive table-bordered table-hover text-center table-condensed">
															...
															@if(isset($allloans))
															@foreach($allloans as $loans => $data)
															<tbody>
																<tr>
																	<input type="hidden" name="_token" value="{{{ csrf_token() }}}">
																	<td>{{ $data['loan_user_id'] }}</td>
